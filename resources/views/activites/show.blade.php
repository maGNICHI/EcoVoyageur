...
.comment-section .timeline-body {
    width: 100%;  /* Fixe la largeur des commentaires à la même taille que le post */
    max-width: 600px; /* Largeur fixe pour les commentaires */
}
.timeline-comment-box {
    margin-top: 20px;
    width: 100%; /* Ajustement pour la largeur du formulaire */
    max-width: 600px; /* Alignement avec le post */
}
...
.input-group {
    display: flex;
    width: 100%; /* Ajustement pour que l'input et le bouton prennent toute la largeur */
}
